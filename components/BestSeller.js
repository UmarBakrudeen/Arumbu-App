import { StyleSheet, Text, View, FlatList, useWindowDimensions, SafeAreaView, Image, Pressable, TouchableOpacity } from 'react-native'
  ...
  return (
    <View style={[styles.container, {
      ...
      <View style={{ alignItems: 'center' }}>
        <Image source={item.Img} style={{ width: CARD_SIZE - 20, height: CARD_SIZE - 20, borderRadius: 5 }} />
      </View>
